...
import {BsPerson} from 'react-icons/bs'
 const Sidenav = () => {
  ...
  return (
    <div>
       <AiOutlineMenu onClick={handleNav} className='absolute top-4 right-6 z-[99] md:hidden'/>
       {
        nav? (
          <div className='fixed w-full h-screen bg-white/90 flex items-center gap-4  flex-col justify-center z-20' >
